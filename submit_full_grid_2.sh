...
#SBATCH --output=/geode2/home/u040/joshnunl/BigRed200/voting-optimization/logs/full2_%A_%a.out
#SBATCH --error=/geode2/home/u040/joshnunl/BigRed200/voting-optimization/logs/full2_%A_%a.err
#SBATCH --array=0-499
...
TOTAL_JOBS=4200
TOTAL_TASKS=1000
TASK_ID=$(( SLURM_ARRAY_TASK_ID + 500 ))   # 500-999
